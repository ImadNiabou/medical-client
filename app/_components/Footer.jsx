...
const Footer = () => {
  return (
    <div>
      <footer className="w-full bg-gradient-to-tr from-gray-950 via-gray-600 to-primary rounded-t-xl rounded-b-none">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 lg:gap-8 gap-12 pt-14 pb-20 max-w-md mx-auto md:max-w-xl lg:max-w-full">
            <div className="block">
              <h4 className="text-xl text-white font-bold mb-7">Medical</h4>
              <ul className="text-lg  transition-all duration-500">
                ...
                <li>
                  <a
                    href="javascript:;"
                    className=" text-gray-200 hover:text-prprimary"
                  >
                    Pro Version
                  </a>
                </li>
          ...
          <div className="py-7 border-t border-gray-700 ">
            <div className="flex items-center justify-center flex-col lg:space-y-0 space-y-8 lg:justify-between lg:flex-row">
              ...
              <span className="text-gray-200  block">
                ©<a href="https://imadniabou.com/">Medical</a> 2024, All rights
                reserved Imad Niabou .
              </span>
